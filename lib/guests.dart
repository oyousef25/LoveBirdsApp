              ...
              body: FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot snapshotGuest) {
                    ...
                    if (snapshotGuest.hasError) {
                      return Center(
                        child:
                            Text('There was an error fetching the guest data'),
                      );
                                    ...
                                    children: [
                                      Card(
                                          ...
                                          child: ListTile(
                                              ...
                                              title: Text('${_chips[_selectedIndex!]}',
                                                  textAlign: TextAlign.center,
                                                  style: Constants
                                                      .cardHeaderStyle),
                                              subtitle: Text('${snapshotGuest.data.length} Guests',
                                                  textAlign: TextAlign.center,
                                                  style: Constants
                                                      .cardContentStyle))),
                                      Wrap(
                              ...
                              itemBuilder: (context, index) {
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                        snapshotRelationship.data[snapshotGuest
