    ...
    return FutureBuilder(
        ...
        builder: (context, AsyncSnapshot snapshotAccount) {
          ...
          if (snapshotAccount.hasError) {
            ...
            // Fetch the tasks after account is confirmed
            futureTasks = Task.fetchAllTasks(snapshotAccount.data.email);
                    ...
                    Expanded(
                      child: FutureBuilder<List<Task>>(
                        ...
                        builder: (context, AsyncSnapshot snapshotTasks) {
                                ...
                                return GestureDetector(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.of(context).push(MaterialPageRoute(
                                        builder: (context) => ViewTask(task: snapshotTasks.data[index])));
                                  },
                                  ...
                                  child: Card(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(snapshotTasks.data[index].task,
                                                  textAlign: TextAlign.left,
                                                  style: Constants.listTitleStyle),
                                              const Padding(
                                                  padding: EdgeInsets.only(bottom: 2)),
                                              Text(snapshotTasks.data[index].dueDate,
                                                  textAlign: TextAlign.left,
                                        ...
                                        Row(
                                          children: [
                                            Text("\$" + snapshotTasks.data[index].cost,
                                                textAlign: TextAlign.right,
                          ...
                          }else if(snapshotTasks.hasError){
                            return Text('${snapshotTasks.error}');
                          }
